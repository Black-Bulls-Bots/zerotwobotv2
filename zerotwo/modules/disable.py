...
from zerotwo.helpers.handlers import CMD_STARTERS, SpamChecker
from zerotwo.helpers.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from zerotwo.helpers.chat_status import (
        connection_status,
        is_user_admin,
        check_admin,
    )
    from zerotwo.sql import disable as sql
